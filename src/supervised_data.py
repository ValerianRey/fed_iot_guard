...
def get_dataset(data: ClientData, multiclass: bool = False) -> Dataset:
...
def get_train_dl(client_train_data: ClientData, train_bs: int, multiclass: bool = False) -> DataLoader:
...
def get_test_dl(client_test_data: ClientData, test_bs: int, multiclass: bool = False) -> DataLoader:
    dataset_test = get_dataset(client_test_data, multiclass=multiclass)
...
def get_train_test_dls(train_data: FederationData, test_data: FederationData, train_bs: int, test_bs: int,
    ...
    train_dls = [get_train_dl(client_train_data, train_bs, multiclass=multiclass) for client_train_data in train_data]
    test_dls = [get_test_dl(client_test_data, test_bs, multiclass=multiclass) for client_test_data in test_data]
